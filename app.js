  ...
  manuals: [
    {
      ...
      fieldList: [
        ...
        },
        {
          label: "修理希望箇所・修理上限金額",
          value:
            "有償修理希望のお客様のみオレンジ枠も記入。現金またはPayPayでしか払えないこと、修理費に上限を設定できることを説明する。",
        },
      ],
      detail: [
        "お客様には点検票に記入いただきます。必須は赤枠、有料修理の希望がある方はオレンジ枠も必須です。点検内容以外の欄は、指示に沿って記入してもらって構いません。",
        "学生生活110番に登録しているかも必ず確認してください。",
        "受付は〜15:30まで,引取は〜16:30までです。",
        "点検票はGIが常に持ち、紛失しないよう管理します。記入後は引換証（小さな紙）を渡し、点検表と同じ番号と受取16:30までを明記し、なくさないよう伝えます。",
        "記入後は点検票をJBRの方に渡し、番号の書かれた養生テープを自転車に貼り、修理場所または修理待機場所に移動させます。",
      ],
      dialogue: {
        title: "受付の台詞例",
        preface:
    ...
    },
    {
      ...
      steps: [
        ...
        "自転車に貼ってある養生は剥がしてゴミ箱に捨てるとGOOD",
        "点検票を見て内容を説明。チラシを渡して完了。アンケートは読み込みを促す（強制しないができるだけ答えてもらう）",
    ...
    },
    {
      ...
      detail: [
        ...
        "点検会でできること：",
        "点検して整備不良を見つけること・タイヤ空気入れ・チェーン注油は無料。それ以外の修理は有料。",
        "たとえば2限前に預けて昼休みに受取る、といったことができる。預けるのは15:30まで。受取りは16:30まで。",
        "あらかじめ上限金額を指定してもらえば、その金額の範囲内で修理をする。上限金額を超える場合は直さず指摘のみする。",
      ],
      dialogue: {
        title: "声かけの例",
